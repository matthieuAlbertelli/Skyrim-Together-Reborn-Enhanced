...
void TradePreviewHostMenu::PostDisplay()
{
    ...
    ItemPreviewRasterCapture projectionCapture{};
    ...
    if (projectionTelemetryPending)
    {
        ...
        m_projectionTelemetrySolverRevision =
            projectionTelemetry.solverRevision;
        projectionCaptureStarted = ItemPreviewRasterMeasurer::BeginCapture(
            pDevice,
            pContext,
            projectionTelemetry,
            projectionCapture);
        ...
        {
            ItemPreviewRasterMeasurement measurement{};
    ...
    {
        ItemPreviewRasterMeasurement measurement{};
        (void)ItemPreviewRasterMeasurer::CompleteCapture(
            pContext,
            projectionCapture,
            measurement);
        previewService.SubmitProjectionMeasurement(measurement);
