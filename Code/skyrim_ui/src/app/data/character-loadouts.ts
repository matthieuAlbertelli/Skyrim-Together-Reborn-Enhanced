...
export const CHARACTER_LOADOUTS: readonly CharacterLoadoutDefinition[] = [
      ...
      },
      {
        ...
        options: [
          ...
          },
          {
            ...
            description:
              'Un objet de test prévu pour augmenter légèrement la parade sans imposer de bouclier.',
            rewards: [reward('Pendentif de garde', 1, 'Objet STRE à créer')],
          },
        ],
      },
      {
  ...
  },
  {
    ...
    introduction:
      "Chaque école propose une orientation cohérente. Les sorts coopératifs et objets propres à STRE sont affichés comme contenu fonctionnel, même lorsque leur forme finale n'existe pas encore dans l'ESP.",
    groups: [
      {
        id: 'mage.destruction',
        ...
        options: [
          {
            ...
            description: 'Une école offensive directe, complétée par un manteau partagé.',
            rewards: [
              reward('Flammes'),
              reward('Explosion de braises'),
              reward('Rune de braises'),
              reward('Manteau de braises partagé'),
            ],
          },
          {
            ...
            description: 'Des sorts de givre et une protection coopérative.',
            rewards: [
              reward('Souffle de givre mineur'),
              reward('Explosion de givre'),
              reward('Rune de givre mineure'),
              reward('Manteau de givre partagé'),
            ],
          },
          {
            ...
            description: "Des décharges électriques et un manteau d'étincelles partagé.",
            rewards: [
              reward('Étincelles mineures'),
              reward('Décharge explosive'),
              reward('Rune électrique mineure'),
              reward("Manteau d'étincelles partagé"),
            ],
          },
        ],
      },
  ...
  },
  {
    ...
    introduction:
      "Le voleur reçoit ses outils obligatoires et choisit la manière dont il ouvre les serrures et se fond dans son environnement. Les objets propres à STRE restent annoncés tant que leurs formes ne sont pas créées.",
    groups: [
      {
      ...
      },
      {
        ...
        title: 'Couverture judiciaire',
        kind: 'announcement',
        required: false,
        description: 'Un lot automatique lié à la compétence majeure.',
        rewards: [
          reward('Faux documents annulant une prime', 3, 'Objet STRE à créer'),
        ],
      },
      {
        id: 'thief.speech',
        skill: 'Éloquence',
        title: 'Faux laissez-passer',
        kind: 'announcement',
        required: false,
        description: "Un lot automatique pour préparer l'approche sociale.",
        rewards: [
          reward('Faux documents nominatifs', 3, "Bonus d'éloquence temporaire avec un PNJ"),
        ],
      },
      {
        id: 'thief.lockpicking',
        skill: 'Crochetage · compétence majeure',
        title: 'Matériel de crochetage',
        kind: 'choice',
        required: true,
        description: "Choisissez l'outil qui définit votre approche des serrures.",
        options: [
          {
            id: 'thief.lockpicking.toolkit',
            name: 'Trousse de crochetage',
            subtitle: 'Outil spécialisé',
            description: 'Une trousse tenue en main, accompagnée de cinq crochets.',
            rewards: [
              reward('Trousse de crochetage', 1, 'Objet STRE à créer'),
              reward('Crochets', 5, undefined, 'preview.lockpick', 'Crochet'),
            ],
            previewKey: 'preview.lockpick',
            previewLabel: 'Crochet',
          },
          {
            id: 'thief.lockpicking.picks',
            name: 'Réserve de crochets',
            subtitle: 'Quantité et simplicité',
            description: 'Une grande réserve sans outil spécialisé.',
            rewards: [reward('Crochets', 20, undefined, 'preview.lockpick', 'Crochet')],
            previewKey: 'preview.lockpick',
            previewLabel: 'Crochet',
          },
          {
            id: 'thief.lockpicking.wax',
            name: 'Cire à clé',
            subtitle: 'Reproduire une serrure ouverte',
            description: 'Une cire spéciale accompagnée de cinq crochets.',
            rewards: [
              reward('Cire à clé', 1, 'Objet STRE à créer'),
              reward('Crochets', 5, undefined, 'preview.lockpick', 'Crochet'),
            ],
            previewKey: 'preview.lockpick',
            previewLabel: 'Crochet',
      ...
      },
      {
        id: 'thief.sneak',
        skill: 'Furtivité',
        title: "Milieu d'infiltration",
        kind: 'choice',
        required: true,
        description: "Choisissez l'environnement dans lequel votre tenue révèle tout son potentiel.",
        options: [
          {
            id: 'thief.sneak.nature',
            name: 'Rôdeur sauvage',
            subtitle: 'Territoires naturels',
            description: 'Une tenue sylvestre dont les bonus s’activent en milieu naturel.',
            rewards: [reward('Tenue sylvestre', 1, 'Objet STRE à créer')],
          },
          {
            id: 'thief.sneak.urban',
            name: 'Rôdeur urbain',
            subtitle: 'Villes et villages',
            description: 'Une tenue passe-partout conçue pour les zones habitées.',
            rewards: [reward('Tenue passe-partout', 1, 'Objet STRE à créer')],
          },
          {
            id: 'thief.sneak.dungeons',
            name: 'Rôdeur des profondeurs',
            subtitle: 'Donjons et souterrains',
            description: 'Une tenue adaptée aux ruines, cavernes et profondeurs.',
            rewards: [reward('Tenue des profondeurs', 1, 'Objet STRE à créer')],
          },
        ],
      },
      {
