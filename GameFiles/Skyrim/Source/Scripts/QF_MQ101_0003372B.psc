...
;BEGIN FRAGMENT Fragment_339
Function Fragment_339()
;BEGIN CODE
; STRE Alternate Start - post-Helgen cleanup
...
;BEGIN FRAGMENT Fragment_335
Function Fragment_335()
;BEGIN CODE
; STRE Alternate Start - post-Helgen cleanup
...
;BEGIN FRAGMENT Fragment_337
Function Fragment_337()
;BEGIN CODE
; STRE Alternate Start - post-Helgen cleanup
NorthGate.SetOpen(False)
NorthGate.SetLockLevel(5)
...
;BEGIN FRAGMENT Fragment_358
Function Fragment_358()
;BEGIN CODE
; STRE Alternate Start - finish vanilla chargen/main-quest cleanup
...
;BEGIN CODE
; STRE Alternate Start - make sure no Helgen Keep scenes survive
...
;BEGIN FRAGMENT Fragment_344
Function Fragment_344()
;BEGIN CODE
; STRE Alternate Start - release MQ101 prisoners without running the intro
...
;BEGIN CODE
; STRE Alternate Start - establish post-intro actor positions
...
;BEGIN FRAGMENT Fragment_350
Function Fragment_350()
;BEGIN CODE
; STRE Alternate Start - remove Helgen attack acoustic state
...
;BEGIN FRAGMENT Fragment_341
Function Fragment_341()
;BEGIN CODE
; STRE Alternate Start - post-Helgen cleanup
Alias_Elenwen.TryToDisable()
Alias_Justiciar01.TryToDisable()
...
;BEGIN CODE
; STRE Alternate Start - remove intro-only actors
...
;BEGIN FRAGMENT Fragment_352
Function Fragment_352()
;BEGIN CODE
; STRE Alternate Start - release intro weather and remaining civilians
Weather.ReleaseOverride()
...
;BEGIN FRAGMENT Fragment_354
Function Fragment_354()
;BEGIN CODE
; STRE Alternate Start - establish collapsed Helgen bridge
...
;BEGIN CODE
; STRE Alternate Start - New Game bootstrap
GameHour.SetValue(7)

Debug.Trace("[STRE][AlternateStart] MQ101 STRE New Game branch")

Player.MoveTo(STRENewGameStartMarker)

Debug.Trace("[STRE][AlternateStart] Player moved to STRE inn")
...
Quest Property STREAlternateStartQuest  Auto  

Actor Property Player  Auto  

ObjectReference Property STRENewGameStartMarker  Auto  
